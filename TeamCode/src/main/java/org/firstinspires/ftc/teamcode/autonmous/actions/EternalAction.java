...
/**
 * This is used to describe an action which will always be run until the stop() method is called on it. We do this to standardize actions that don't finish, while implementing this class, also remember to override the runForever() method.
 */
